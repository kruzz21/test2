/*
  ...
  1. New Columns Added
    - `alt_text_tr`, `alt_text_az`, `alt_text_en` for multilingual alt text
    - `categories_tr`, `categories_az`, `categories_en` for multilingual categories/tags
    - `display_order` for custom sorting

  2. Sample Data
    - 8 comprehensive gallery items (5 photos, 3 videos)
    - Complete multilingual content for all fields
...
(
  ...
  'Dr. Eryanılmaz tarafından kişisel tanıtım ve deneyim paylaşımı',
  'Dr. Eryanılmaz tərəfindən şəxsi tanıtım və təcrübə paylaşımı',
